 ...
 *    <script src="/javascripts/simile/exhibit/api-2.0/exhibit-api.js" type="text/javascript"></script>
 *
 *==================================================
 */
...
(function() {
    ...
    var loadMe = function() {
        ...
        if (useLocalResources) {
            Exhibit.urlPrefix = "/javascripts/simile/exhibit/api-2.0/";
        }
        ...
        if (includeTimeline) {
            scriptURLs.push(useLocalResources ?
                "/javascripts/simile/exhibit/extensions-2.0/time/time-extension.js" :
                "http://static.simile.mit.edu/exhibit/extensions-2.0/time/time-extension.js");
        }
        if (includeMap) {
            scriptURLs.push(useLocalResources ?
                "/javascripts/simile/exhibit/extensions-2.0/map/map-extension.js" :
    ...
    if (typeof SimileAjax == "undefined") {
        ...
        var url = useLocalResources ?
            "/javascripts/simile/ajax/simile-ajax-api.js" :
