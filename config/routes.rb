ActionController::Routing::Routes.draw do |map|
  map.resources :flashinfos, :collection => {:data => :get}
  ...
  map.resources :programs, :collection => {:import => :get, :doimport => :get, :autocomplete => :get, :vods => :get, :update_files => :post, :nextvod => :get, :voddone => :get, :published => :get, :vodlist => :get}, :member => {:print => :get}
